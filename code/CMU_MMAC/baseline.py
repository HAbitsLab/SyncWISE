import sys
sys.path.insert(0, '/home/yun/Dropbox (GaTech)/sync/code/cross_corr')
...
if __name__ == '__main__':
    # load video data
    session_list = open('/home/yun/Downloads/CMU/session_list').readlines()
    video_dir = '/home/yun/Downloads/CMU/video'
    opt_dir = '/home/yun/Downloads/CMU/opt_flow'
    IMU_dir = '/home/yun/Downloads/CMU/sensor/'
    data_dir = '/home/yun/Downloads/CMU/data'
    FPS = 30
    ...
    ###                   Baseline                           #
    ##########################################################
    #valid_session_file = '/media/yun/Seagate Backup Plus Drive/SyncWise_win30_max60/valid_sessions_win30_max60.pkl'
    #valid_session_file = '/media/yun/08790233DP/SyncWise2/SyncWise_win30_max60/valid_sessions_win30_max60.pkl'
    ...
    #for sensor in sensors:
        ...
        #os.makedirs('/media/yun/Seagate Backup Plus Drive/figures/baseline_{}_{}/{}'.format(mode_video, mode_imu, sensor), exist_ok=True)
    ## load ground truth
    #offsets = np.zeros(len(session_list))
    ...
    #for i, session in enumerate(session_list):
        ...
        #for sensor in sensors:
            ...
            #if draw:
                #path ='/media/yun/Seagate Backup Plus Drive/figures/baseline_{}_{}/{}/{}.jpg'.format(mode_video, mode_imu, sensor, session)
                #plt.figure()
                #plt.plot(fftshift[::-1])
    ...
    sync_data_dir = '/media/yun/08790233DP/SyncWise2/SyncWise' + suffix
    #sync_data_dir = '/media/yun/Seagate Backup Plus Drive/SyncWise'+suffix
    print(' mode:', mode_video, mode_imu, wind_length, max_shift)
    os.makedirs('/media/yun/Seagate Backup Plus Drive/figures/win{}_max{}'.format(wind_length, max_shift), exist_ok=True)
    offsets, valid_sessions = pickle.load(open('/media/yun/08790233DP/SyncWise2/SyncWise_win60_max60/valid_sessions_win60_max60.pkl', 'rb'))
    ...
    for sensor in sensors:
        ...
        valid_sessions[sensor] = []
        summ_mats[sensor] = []
        os.makedirs('/media/yun/Seagate Backup Plus Drive/figures/win{}_max{}/{}'.format(wind_length, max_shift, sensor), exist_ok=True)
    # load ground truth
    offsets = np.zeros(len(session_list))
    for i, session in enumerate(session_list):
        session = session.strip()
    ...
    for i, session in enumerate(session_list):
        ...
        for sensor in sensors:
            ...
            path = '/media/yun/Seagate Backup Plus Drive/figures/win{}_max{}/{}/{}.jpg'.format(wind_length, max_shift, sensor, session)
